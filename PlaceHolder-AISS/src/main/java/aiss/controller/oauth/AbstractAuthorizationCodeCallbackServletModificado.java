 ...
 * @author Yaniv Inbar
 */
public abstract class AbstractAuthorizationCodeCallbackServletModificado extends HttpServlet {
   ...
   */
  private AuthorizationCodeFlowModificado flow;
   ...
   */
  protected abstract AuthorizationCodeFlowModificado initializeFlow() throws ServletException, IOException;
