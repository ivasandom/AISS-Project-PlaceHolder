 ...
 * @author Yaniv Inbar
 */
public class AuthorizationCodeFlowModificado {
   ...
   * @since 1.14
   */
  public AuthorizationCodeFlowModificado(AccessMethod method,
   ...
   * @since 1.14
   */
  protected AuthorizationCodeFlowModificado(Builder builder) {
   ...
   */
  public AuthorizationCodeTokenRequestModificado newTokenRequest(String authorizationCode) {
    return new AuthorizationCodeTokenRequestModificado(transport, jsonFactory,
  ...
  public static class Builder {
    ...
    public AuthorizationCodeFlowModificado build() {
      return new AuthorizationCodeFlowModificado(this);
    }
