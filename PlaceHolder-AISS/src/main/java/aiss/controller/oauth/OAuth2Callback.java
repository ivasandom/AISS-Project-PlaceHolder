...
import aiss.utility.OAuthRegistryModificado;

/**
 * Servlet implementation class OAuth2Callback
 */
public class OAuth2Callback extends AbstractAuthorizationCodeCallbackServletModificado {
    ...
    @Override
    protected AuthorizationCodeFlowModificado initializeFlow() throws IOException {
        return OAuthRegistryModificado.initializeFlow(getInitParameter("provider"));
    }
