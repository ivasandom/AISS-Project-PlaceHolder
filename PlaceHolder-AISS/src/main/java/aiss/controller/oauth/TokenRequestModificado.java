 ...
 * @author Yaniv Inbar
 */
public class TokenRequestModificado extends GenericData {
   ...
   *        grant type)
   */
  public TokenRequestModificado(HttpTransport transport, JsonFactory jsonFactory, GenericUrl tokenServerUrl,
      String grantType) {
   ...
   * </p>
   */
  public TokenRequestModificado setRequestInitializer(HttpRequestInitializer requestInitializer) {
   ...
   * </p>
   */
  public TokenRequestModificado setClientAuthentication(HttpExecuteInterceptor clientAuthentication) {
   ...
   * </p>
   */
  public TokenRequestModificado setTokenServerUrl(GenericUrl tokenServerUrl) {
   ...
   * @since 1.15
   */
  public TokenRequestModificado setScopes(Collection<String> scopes) {
   ...
   * </p>
   */
  public TokenRequestModificado setGrantType(String grantType) {
  ...
  @Override
  public TokenRequestModificado set(String fieldName, Object value) {
    return (TokenRequestModificado) super.set(fieldName, value);
  }
}
