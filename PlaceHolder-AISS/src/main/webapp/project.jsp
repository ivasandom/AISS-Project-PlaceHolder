	...
	<main role="main mt-5 pt-5">
		...
		<div class="jumbotron">
			<div class="container">
  			...
  			<button class="btn btn-danger btn-sm" id="delete-confirm" data-url="/projects/delete?id=${project.id}">Eliminar proyecto</button>
  			<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#updateProject" data-url="/projects/update?id=${project.id}" data-whatever="@getbootstrap">Actualizar proyecto</h1>
